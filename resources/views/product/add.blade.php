            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" id="form-upload" action="{{ url('product/store') }}"
                        ...
                        <div class="row">
                            <div class="col-4 mr-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control d-block" type="text" min="0" max="100" name="discount"
                                        id="discount" placeholder="Tính theo phần trăm (%)"
                                        value="{{ Old('discount') }}" />
                                    @error('discount')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <input type="submit" name="btn_add_basic_info" class="btn btn-primary mt-3" value="Thêm mới">
                    </form>
                </div>
            </div>
        </div>
